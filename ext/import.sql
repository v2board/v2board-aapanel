...
INSERT INTO `v2_user` (`id`, `invite_user_id`, `telegram_id`, `email`, `password`, `password_algo`, `balance`, `discount`, `commission_type`, `commission_rate`, `commission_balance`, `t`, `u`, `d`, `transfer_enable`, `banned`, `is_admin`, `is_staff`, `last_login_at`, `last_login_ip`, `uuid`, `group_id`, `plan_id`, `remind_expire`, `remind_traffic`, `token`, `remarks`, `expired_at`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, 'admin@v2board.com', '$2y$10$kKQgD6UqC1j08Xw93lmjI.4cBC/z6HZMZ2bsGCLC2cTKZDOaZICC2', NULL, 0, NULL, 0, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, '0c4e8465-2959-4123-8081-2d8f0039e606', NULL, NULL, 1, 1, '0026650608e95dba8646a1317dd323c9', NULL, 0, 1630949750, 1630949750);
